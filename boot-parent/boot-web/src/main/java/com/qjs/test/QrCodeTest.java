...
public class QrCodeTest {
	...
	public void test1() throws IOException {
		...
		ByteArrayOutputStream stream = QRCode.from("http://weixin.qq.com/q/02y1qu5sIXcn31M2GM1o18").to(ImageType.JPG)
				.stream();
	...
	public void test2() throws IOException {
		...
		ByteArrayOutputStream stream = QRCode.from(johnDoe).to(ImageType.JPG).stream();
